            ...
            <p>
                ...
                <form action="${pageContext.servletContext.contextPath}/register" method="post">
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" class="form-control" placeholder="Create login (5-25 chars) " name="login" id="login" onchange="loginCheck()" >
                    </div>
                    <span class="error" id="loginSpan">${errorLogin}</span>
                    <div class="input-group input-group-lg">
                         <span class="input-group-addon"><i class="fa fa-user"></i></span>
                         <input type="text" class="form-control" placeholder="Your name (2-28 chars)" name="name" id="name" onchange="nameCheck()" >
                    </div>
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <input type="password" class="form-control" id="pass" placeholder="Create your password" name="password" onchange="srav()" >
                    </div>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                         <input type="password" class="form-control" placeholder="Repeate your password" id="repeatePass" onchange="srav()" >
                    </div> <span id="error" class="error"></span>


                    <button type="submit" value="Ok" class="float" id="okButton" onmousemove="registration()" onmouseover="registration()" >Ok</button>
                </form>
